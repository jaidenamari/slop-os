...
## Context
This project demonstrates proper usage of cursors agentic layer and content practices. We use TypeScript/Node.js with a focus on clean architecture and test-driven development.
...
- Always us `bun` over `npm` `pnpm` or `yarn`
...
6. Keep components and files under 500 lines.
...
- For python types, never use Dict, always use a concreate pydantic model with typed fields 